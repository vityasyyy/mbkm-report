...
Selama periode magang dari tanggal \textbf{9 Februari 2026 hingga 22 Juni 2026}, penulis ditempatkan dalam tim Software Engineering yang bertanggung jawab atas pengembangan dan pemeliharaan platform Digital Employee serta GL-IAM SDK. Kegiatan magang meliputi:
...
\begin{enumerate}
    ...
    \item \textbf{Implementasi Prototipe Produk}: Membangun proof-of-concept untuk skenario penggunaan agen AI dalam lingkungan sandbox (E2B), eksplorasi pipeline Retrieval-Augmented Generation (RAG), serta pengembangan prototipe analisis masukan AI pada pull request.
