...
Penulis aktif dalam memberikan dan menerima code review, yang membiasakan komunikasi teknis yang konstruktif, penerimaan terhadap kritik (growth mindset), serta pemahaman bahwa kode adalah tanggung jawab kolektif tim, bukan individu.

\subsubsection{GitHub Projects dan Task Tracking}

Proyek dikelola melalui GitHub Projects dengan kolom-kolom status: To Do, In Progress, In Review, Done. Selama magang, penulis secara aktif memperbarui status tugas, menambahkan komentar pada issue terkait, serta menjelaskan alasan teknis setiap keputusan dalam thread diskusi. Fungsi GitHub Issues juga digunakan untuk melacak bug, perencanaan fitur, dan diskusi desain bersama tim.
